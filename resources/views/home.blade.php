...
<head>
  ...
  <title>Penyewaan Buku Perpustakaan | Dashboard</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/member" class="nav-link">Penyewaan Buku Perpustakaan</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="adminlte/dist/img/AdminLTELogo.png"  alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Sistem Perpustakaan</a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Borrowing Step</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
