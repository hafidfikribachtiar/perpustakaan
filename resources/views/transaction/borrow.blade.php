...
<input type="text" class="form-control" id="kategori" 
                    ...
                    name="category" placeholder="Kategori Buku" readonly="true">
...
<label for="category">Tanggal Pinjam</label>
...
let url = $(this).data('url')+'/transaction/showBuku/'+id_buku;
...
let url = $(this).data('url')+'/transaction/getAnggota/'+id_anggota;
